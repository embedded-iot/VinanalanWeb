...
const STRINGS = {
  ADD_ROOM_CATALOG: <FormattedMessage id="ADD_ROOM_CATALOG" />,
  EDIT_ROOM_CATALOG: <FormattedMessage id="EDIT_ROOM_CATALOG" />,
...
class AddRoomsCatalog extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selected: {
...
export default injectIntl(connect(mapStateToProps)(AddRoomsCatalog));
