...
// const SERVER = "http://107.113.186.155:3300";
const SERVER = "http://35.185.47.170:3300";
const REQUEST_HEADER = { 'Content-Type': 'application/json', 'access_token': localStorage.getItem('token') };
...
export function makeGetRequest(config, successCallback, failCallback) {
    ...
    if (requestConfig.headers) {
        requestConfig.headers = extend(requestConfig.headers, {
            "device-name": os.name,
