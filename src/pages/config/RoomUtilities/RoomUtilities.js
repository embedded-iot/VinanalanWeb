...
import AddIncomeUtility from "./AddRoomUtility";
import ButtonList from "../../../components/commons/ButtonList/ButtonList";
import ViewRoomUtility from "./ViewRoomUtility";
...
class RoomUtilities extends Component {
  constructor(props) {
    super(props);
    this.state = {
      dataSource: [],
        ...
        return (
          <div className="actions-column">
            ...
            <Tooltip title={STRINGS.EDIT}>
              <span className="icon icon-edit" onClick={() =>this.editRoomUtility(id)}></span>
            </Tooltip>
            <Tooltip title={STRINGS.ACTION_DELETE}>
              <span className="icon icon-delete" onClick={() =>this.deleteRoomUtility(id)}></span>
            </Tooltip>
          </div>
        )
      },
  ...
  onChange = (pagination = {}, filters = {}, sorter  = {}, extra, searchText) => {
    ...
    this.setState({
      ...
      loading: true });
    dispatch(spinActions.showSpin());
    Services.getRoomUtilities({...params,}, (response) => {
      dispatch(spinActions.hideSpin());
      const tableSettings = {
        ...this.state.tableSettings,
...
export default injectIntl(withRouter(connect()(RoomUtilities)));